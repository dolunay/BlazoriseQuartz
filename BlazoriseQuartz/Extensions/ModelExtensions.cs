...
namespace BlazoriseQuartz.Extensions
{
		...
		public static string GetTriggerTypeIcon(this TriggerType triggerType)
		{
			switch (triggerType)
			{
				case TriggerType.Cron:
					return MaterialIcons.Schedule;
				case TriggerType.Daily:
					return MaterialIcons.Alarm;
				case TriggerType.Simple:
					return MaterialIcons.Repeat;
				case TriggerType.Calendar:
					return MaterialIcons.CalendarMonth;
				default:
					return MaterialIcons.Settings;
			}
		}
