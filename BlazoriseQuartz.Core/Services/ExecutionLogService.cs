...
namespace BlazoriseQuartz.Core.Services
{
    ...
    {
        private readonly IDbContextFactory<BlazoriseQuartzDbContext> _contextFactory;
        public ExecutionLogService(IDbContextFactory<BlazoriseQuartzDbContext> contextFactory)
        {
