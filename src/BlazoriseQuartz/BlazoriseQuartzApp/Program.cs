...
builder.Services.AddBlazoriseQuartzUI(builder.Configuration.GetSection("BlazoriseQuartz"),
    connectionString: builder.Configuration.GetConnectionString("BlazoriseQuartzDb"));
...
app.UsePathBase("/BlazoriseQuartzUI");
app.UseStaticFiles();
...
app.UseBlazoriseQuartzUI();
app.UseEndpoints(endpoints =>
{
    endpoints.MapBlazorHub();
    endpoints.MapFallbackToPage("/BlazoriseQuartzUI/_Host");
});
